...
struct background
{
  ...
  int index_bg_chi_ncdmfft;   /**< comoving neutrino horizon */
  ...
  int index_bi_chi_ncdmfft;   /**< {B} comoving neutrino horizon [index_N_ncdm][index_q] */
  ...
  short has_ncdmfft;   /**< use of ncdmfft method? */
