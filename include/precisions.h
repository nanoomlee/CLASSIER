...
/* Parameters related to ncdmfft acceleration scheme */
class_precision_parameter(N_conv_ncdmfft,int,1024)  /**< Sample size of bessel functions in ncdmfft. */
...
//!!!!!!
//class_precision_parameter(N_tau_ncdmfft_size_scale,int,160)  /**< linear scale in N in k. */
//class_precision_parameter(N_tau_ncdmfft_size_scale,int,100)  /**< linear scale in N in k. */
//class_precision_parameter(N_tau_ncdmfft_size_scale,int,2500)  /**< linear scale in N in k. */
class_precision_parameter(N_tau_ncdmfft_size_scale,int,10000)  /**< linear scale in N in k. */
//class_precision_parameter(N_tau_ncdmfft_size_scale,int,10000)  /**< linear scale in N in k. */
//class_precision_parameter(N_tau_ncdmfft_size_scale,int,4000)  /**< linear scale in N in k. */

class_precision_parameter(min_x_samples_ncdmfft,int,250)  /**< linear scale in N in k. */

class_precision_parameter(l_max_ncdmfft,int,3)  /**< max l to truncate for ansatz ncdmfft loop */

//class_precision_parameter(k_min_ncdmfft,double,0.000001)  /**< minimum k mode which where ncdmfft is used. At low k_modes ncdmfft tends to become numericially noisy. This can be also circumvented by increasing N_conv_ncdmfft and N_tau_ncdmfft_sample_size */
...
//class_precision_parameter(k_min_ncdmfft,double,0.699)  /**< minimum k mode which where ncdmfft is used. At low k_modes ncdmfft tends to become numericially noisy. This can be also circumvented by increasing N_conv_ncdmfft and N_tau_ncdmfft_sample_size */
//class_precision_parameter(k_min_ncdmfft,double,0.74)  /**< minimum k mode which where ncdmfft is used. At low k_modes ncdmfft tends to become numericially noisy. This can be also circumvented by increasing N_conv_ncdmfft and N_tau_ncdmfft_sample_size */
class_precision_parameter(print_ncdmfft,int,0)
/**< whether printed. */

class_string_parameter(ncdmfft_debug_dir,"/../data/run_0","ncdmfft_debug_dir")  /**< TODO remove: debug only */
