...
struct perturbations
{
  ...
  /** Do we want to solve ncdm equations explicitely, or through the FFT iterative method of 2201.11129 ? */
  short has_ncdmfft;
  ...
  int N_G1_freq_max;       /**< the maximum # of frequencies for NUFFT with G1 **/
  int N_G2_freq_max;       /**< the maximum # of frequencies for NUFFT with G2 **/
  int ntrans;              /**< dimension for vectorization of NUFFT **/

  finufft_plan * list_r2c_plans_ncdmfinufft_G1;  // (NL)
  finufft_plan * list_c2r_plans_ncdmfinufft_G1;  // (NL)
  finufft_plan * list_r2c_plans_ncdmfinufft_G2;  // (NL)
  finufft_plan * list_c2r_plans_ncdmfinufft_G2;  // (NL)
...
struct perturbations_workspace
{
  ...
  */
  ...
  int index_loop_ncdmfft;     /**< current loop of the ncdmfft process */
  int N_loops_ncdmfft;         /**< max loop of the solve evaluate process. Obtained from precision file */
  double ncdm_fluid_trigger_tau_over_tau_k;

  finufft_plan r2c_plan_ncdmfinufft_G1;  // (NL)
  finufft_plan c2r_plan_ncdmfinufft_G1;  // (NL)
  ...
  Gcoefficients * Bcoeff;

  double k;  /**< current k value only for debugging */
  double * xi_max_qbin;  /**< xi_max for each q-bin (NL) */
  double * xi_star_qbin;  /**< xi_star for each q-bin (NL) */

  double ** rho_delta_ncdm_ncdmfft;    /**< the density perturbation of the ncdm species for ncdmfft evaluation */ 
  double ** rho_delta_ncdm_ncdmfft_spline;    /**< the density perturbation of the ncdm species for ncdmfft evaluation */
  double ** rho_plus_p_theta_ncdm_ncdmfft;    /**< the (rho+p)*theta of the ncdm species for ncdmfft evaluation */
  double ** rho_plus_p_theta_ncdm_ncdmfft_spline;    /**< the (rho+p)*theta of the ncdm species for ncdmfft evaluation */
  double ** rho_plus_p_shear_ncdm_ncdmfft;    /**< the (rho+p)*shear of the ncdm species for ncdmfft evaluation */
  double ** rho_plus_p_shear_ncdm_ncdmfft_spline;    /**< the (rho+p)*shear of the ncdm species for ncdmfft evaluation */
  double ** delta_p_ncdm_ncdmfft;   /**< the pressure perturbation of the ncdm species for ncdmfft evaluation */
  double ** delta_p_ncdm_ncdmfft_spline;   /**< the pressure perturbation of the ncdm species for ncdmfft evaluation */
  
  double complex *** fft_kernels_ncdmfft_G1;  /**< the FFT of spherical Bessel */
  double complex *** fft_kernels_ncdmfft_G2;  /**< the FFT of spherical Bessel */
  ...
  double ** xi_ncdmfft_sampling;    /**< array of x = k * chi(0,tau) values for all q and all massive neutrino species */
  double * KG1_maxq;    /**< convolution with G1 for q_max */

  double * a_ncdmfft; /**< the scale factor for ncdmfft*/
